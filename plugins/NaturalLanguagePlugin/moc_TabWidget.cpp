...
QT_MOC_LITERAL(1, 10, 11), // "newTabAdded"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 5) // "index"

    },
    "TabWidget\0newTabAdded\0\0index"
};
...
void TabWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newTabAdded((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TabWidget::newTabAdded)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TabWidget::newTabAdded(int _t1)
{
